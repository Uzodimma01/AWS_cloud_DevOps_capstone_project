...
docker_image_name=$(<../variables/docker_image_name.txt):$(<../variables/docker_image_tag.txt)
replica_set=$(<../variables/node_replica_set.txt)
max_surge=$(<../variables/max_surge.txt)
max_unavailable=$(<../variables/max_unavailable.txt)
docker_image_path=$(<./variables/dockerhub_image_path.txt)/$(<./variables/docker_image_name.txt):$(<./variables/docker_image_tag.txt)
